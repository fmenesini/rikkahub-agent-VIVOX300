...
class GenerativeModel { suspend fun checkStatus(): Int = 3; suspend fun warmup() {}; fun generateContentStream(r: GenerateContentRequest): Flow<GenerateContentResponse> { FakeAICore.requests += r; return FakeAICore.script.removeAt(0)(r) }; fun close() {} }
